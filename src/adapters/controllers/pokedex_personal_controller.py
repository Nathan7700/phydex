...
from src.usecases.pokedex_personal.favorite_pokemon_usecase import FavoritePokemonUseCase
from src.usecases.pokedex_personal.capture_pokemon_usecase import CapturePokemonUseCase
